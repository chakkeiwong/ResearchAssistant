...
- `p_dq_ed9221ee9d933fa9115590093e325e9c8f3b29a50f065b7d097e8cee87abb129`: Neural Optimal Transport

## Provider Status

- `arxiv` `seed_resolution`: available (0 records)
- `arxiv` `topic_search`: available (0 records)
- `openalex` `seed_resolution`: available (1 records)
- `openalex` `topic_search`: available (0 records)

## Candidate Metadata Rows

- `p_dq_ed9221ee9d933fa9115590093e325e9c8f3b29a50f065b7d097e8cee87abb129`: Neural Optimal Transport; roles: seed; providers: openalex.
