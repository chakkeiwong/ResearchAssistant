...
## Candidate Ledger
- Candidates: 2
- `p_dq_ed9221ee9d933fa9115590093e325e9c8f3b29a50f065b7d097e8cee87abb129` Neural Optimal Transport: source `metadata_only_or_not_selected_for_phase4`, anchors `0`
- `p_dq_34fb9516a5f4a1ef50ee16f961663f6aed3705658959c989d0221989215072db` Neural Optimal Transport Direct Method: source `metadata_only_or_not_selected_for_phase4`, anchors `0`

## Source Support
- Source intake status: `completed_with_outcomes`
- Fetched source count: `None`
- Source gaps: `0`
- `paper_openalex_w100_fc9a224b790d` arXiv `None`: 1 checked anchor candidates; technical support `not_supported_until_claim_mapping_review`

## Paper Classifications
- Classification rows: 2
...
- `paper_openalex_w100_fc9a224b790d` `section:sec:method` (section, role `method_anchor_candidate`): claim status `anchor_available_claim_not_mapped`
...
- Candidate `candidate_claim_001` from `paper_openalex_w100_fc9a224b790d` anchor `section:sec:method`: status `review_required`, claim support allowed `false`
...
- `paper_openalex_w100_fc9a224b790d` normalized safety `not_checked_phase5`, claim support allowed `false`
- `paper_openalex_w100_fc9a224b790d` retraction/version `not_checked_phase5`, claim support allowed `false`
