...
- `p_dq_a995b9386b6a30198112e8e5301ab9a6ac88e00cd937721eb3de3db554edb126`: Neural Optimal Transport

## Provider Status

- `arxiv` `seed_resolution`: available (1 records)
- `arxiv` `topic_search`: available (0 records)
- `openalex` `seed_resolution`: available (0 records)
- `openalex` `topic_search`: available (1 records)

## Candidate Metadata Rows

- `p_dq_a995b9386b6a30198112e8e5301ab9a6ac88e00cd937721eb3de3db554edb126`: Neural Optimal Transport; roles: seed; providers: arxiv.
- `p_dq_44fa4be6eb88fe208f9f8f3441ba409c84871e9ead9104db208b9a2f344adafe`: Neural Transport Candidate; roles: metadata_candidate; providers: openalex.
...
- This packet does not prove complete live web coverage beyond the bounded max-records=25 provider queries.
